...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        # unread_count = await sync_to_async(Message.get_unread_count)(sender=sender, receiver=receiver)
        # receiver_unread_count = await sync_to_async(Message.get_unread_count)(
        # sender=sender, receiver=receiver
        # )

        # Prepare chat structure
        message_data = {
            "id": chat_message.id,
            "sender_profile": {
                "email": sender.email,
